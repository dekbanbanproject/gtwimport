...
class Clinic_drug extends Model
{
     ...
     protected $fillable = [
          'ID','FINGLE_ID','HR_CID','HR_PREFIX_ID','HR_FNAME','HR_LNAME',
        'HR_EN_NAME','PAY','SEX','HR_BLOODGROUP_ID','HR_MARRY_STATUS_ID',
        'HR_BIRTHDAY','HR_PHONE','HR_EMAIL','HR_FACEBOOK','HR_LINE','HR_HOME_NUMBER','HR_VILLAGE_NO','HR_ROAD_NAME',
        ...
        'HR_KIND_ID','HR_KIND_TYPE_ID','LINE_NAME','LINE_TOKEN','LINE_TOKEN1','LINE_TOKEN2','HR_IMAGE_NAME','HR_AGENCY_ID'
     ];
}
