...
class FontendController extends Controller
{
  public function welcome(Request $request)
    {
      $person = DB::table('hrd_person')->leftJoin('hrd_prefix','hrd_person.HR_PREFIX_ID','=','hrd_prefix.HR_PREFIX_ID')
      ...
      ->get();
      return view('gtimport',[
        'persons' => $person,
      ]);
    }

    function hrdperson_excel(Request $request)
    {      
        $file = $request->HRD_PERSON_EXCEL;
        Excel::import(new Hrdperson,$file);
       return redirect()->route('Per.welcome')->with('success','นำเข้าข้อมูลเรียบร้อยแล้ว');
    }
    public function hrdperson_excel_save(Request $request)
      {
        ...
        {        
         ...
         return redirect()->route('importusers')->with('success','นำเข้า Users เรียบร้อยแล้ว');
     }
